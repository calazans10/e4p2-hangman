defmodule Hangman.Impl.GameTest do
  ...
  describe "new_game/1" do
    test "returns initializing when correct word is given" do
    ...
    test "returns not initialized when invalid word is given" do
      game = Game.new_game("S3cr3T")

      assert game.turns_left == 0
      assert game.game_state == :not_initialized
      assert game.letters == []
    end
  end
  ...
  describe "make_move/2" do
    ...
    test "can handle a sequence of moves" do
      [
        ...
        ["X", :invalid_guess, 5, ["_", "e", "_", "_", "_"], ["a", "e", "x"]]
      ]
    ...
    test "can handle a losing game" do
      [
        ...
        ["C", :invalid_guess, 4, ["_", "_", "_", "_", "_"], ["a", "b", "c"]],
